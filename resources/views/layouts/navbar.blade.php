            ...
            <div class="d-flex flex-column flex-lg-row align-items-stretch align-items-lg-center gap-2 gap-lg-3 mt-3 mt-lg-0 w-100">
                ...
                <div class="d-none d-lg-block ms-auto">
                    <div class="input-group">
                        ...
                        <input type="search" class="form-control bg-secondary bg-opacity-25 text-white border-secondary" style="min-width: 200px;" placeholder="بحث سريع..." aria-label="بحث سريع">
                    </div>
                </div>

                {{-- بحث الهاتف (يظهر داخل قائمة الجوال) --}}
                <div class="d-lg-none">
                    <div class="input-group w-100">
                        <span class="input-group-text bg-secondary bg-opacity-25 text-white border-secondary">
                            <i class="bi bi-search"></i>
                        </span>
                        <input type="search" class="form-control bg-secondary bg-opacity-25 text-white border-secondary" placeholder="بحث سريع..." aria-label="بحث سريع">
                    </div>
                </div>
