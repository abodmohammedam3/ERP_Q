...
<div class="card mb-3">
    <div class="card-body">
        <form id="paymentVoucherForm" novalidate>
            ...
            <!-- رقم السند (مخفي) -->
            <input type="hidden" id="PaymentVoucherNumber" name="voucherNumber" value="">
            <input type="hidden" id="PaymentVoucherDate" name="voucherDate" value="">

            <!-- ═══════════════════════════════════════════════ -->
            <!--  الصف الأول: الحساب الدائن (المورد) + طريقة الدفع + الحساب المدين -->
            <!-- ═══════════════════════════════════════════════ -->
            <div class="row g-3 mb-3">

                <!-- 1. الحساب الدائن (المورد) -->
                <div class="col-md-6">
                    <label for="CreditAccountName" class="form-label">
                        الحساب الدائن (المورد) <span class="text-danger">*</span>
                    </label>
        ...
        <div class="card h-100 summary-card">
            <div class="card-body d-flex flex-column justify-content-center">
                ...
                <div class="d-flex justify-content-between border-top pt-2 mt-2">
                    <span class="text-muted">المبلغ المصروف:</span>
                    <span class="text-danger fw-bold" id="SummaryPaid">0.00</span>
                </div>
                <div class="d-flex justify-content-between border-top pt-2 mt-2">
