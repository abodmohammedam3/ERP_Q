<div class="card shadow-sm mb-3">
    ...
    <div class="card-body">
        <div class="row g-3">
            ...
            {{-- رقم الحركة --}}
            <div class="col-md-2">
                <label for="movementDisplayId" class="form-label">رقم الحركة</label>
                <input
                    type="text"
            ...
            {{-- اتجاه الحركة --}}
            <div class="col-md-2">
                <label for="movementDirection" class="form-label">اتجاه الحركة</label>
                <input
                    type="text"
            ...
            {{-- رقم المستند --}}
            <div class="col-md-2">
                <label for="movementDocumentNumber" class="form-label">رقم المستند</label>
                <input
                    type="text"
            ...
            <div class="col-md-2">
                ...
                <input
                    ...
                    autocomplete="off"
                    onkeydown="movementWarehouseHeaderKeyDown(event)"
                >
            ...
            {{-- البيان --}}
            <div class="col-12">
                <label for="movementStatement" class="form-label">البيان</label>
                <textarea
