        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="bi bi-currency-exchange"></i> اختيار العملة
                </h5>
            ...
            <div class="modal-body">
                ...
                <div class="row g-2 mb-3">
                    <div class="col-md-10">
                        <input type="text" class="form-control" id="currencySearchInput"
                               ...
                               oninput="currencyInput(event)"
                               onkeydown="if(event.key==='Enter') searchCurrencies()">
                    </div>
                    <div class="col-md-2">
                        <button type="button" class="btn btn-primary w-100"
                                onclick="searchCurrencies()">بحث</button>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody id="currencyResults"></tbody>
                    </table>
                </div>
...
<template id="currencyRowTemplate">
    <tr>
        <td class="c-id"></td>
        <td class="c-name"></td>
        <td class="c-code"></td>
