...
@section('content')
    ...
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
        <div>
            <div class="d-flex align-items-center gap-2 mb-1">
                ...
                <h4 class="mb-0 fw-bold">دليل الحسابات</h4>
            </div>
            <p class="text-body-secondary mb-0">إدارة وتنظيم الحسابات.</p>
        </div>
    ...
    {{-- جدول الحسابات + مودال التحليلية (يستخدم @push داخلياً) --}}
    @include('setting.accounting.chartOfAccounts.display')

    {{-- ✅ هذه الـ includes تُرندَر الآن عبر @push('modals') --}}
